...
def update_display(layout, spinner_text=None):
    ...
    layout["header"].update(
        Panel(
            ...
            "[dim]© TradingAgents contributors (https://github.com/thsvc/TradingAgents)[/dim]",
...
def get_user_selections():
    ...
    welcome_content += (
        "[dim]Built by the TradingAgents community (https://github.com/thsvc/TradingAgents)[/dim]"
    )
